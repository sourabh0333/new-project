...
const SecCateA = () => {
  ...
  return (
    <div className="px-4 space-y-4 bg-white">
      {/* Category Buttons */}
                ...
                <div className="w-16">
                  {/* {qty === 0 ? (
                    <button
                      ...
                      className="w-full bg-blue-500 py-1 text-white rounded-sm flex justify-center items-center gap-1 text-sm font-medium cursor-pointer"
                    >
                      <span className="text-md">+</span> Add
                    </button>
                  ) : (
                    <div className="flex items-center justify-between border border-blue-500 text-black rounded-sm px-2">
                      <button
                        onClick={() => handleRemove(item.name)}
                        className="text-xl px-1 cursor-pointer text-blue-500"
                      >
                        -
                      </button>
