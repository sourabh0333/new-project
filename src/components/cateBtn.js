...
const CateBtn = () => {
  ...
  return (
    <div className="p-4 space-y-4 bg-white">
      ...
      <div className="grid grid-cols-3 gap-3.5 mb-16">
        {filteredItems.map((item, index) => {
          const qty = cart[item.name] || 0;
          return (
            <div key={index} className="w-full h-[202px]">
              ...
              <div className="mt-1 w-[70%]">
                {qty === 0 ? (
                  ...
                  <div className="flex items-center justify-center border border-blue-500 text-black rounded-sm px-2">
                    <button
