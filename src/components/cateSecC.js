              ...
              <div className="w-[40%]">
                ...
                <div className="mt-2">
                  ...
                  {/* {qty === 0 ? (
                    ...
                    <div className="w-[50%] flex items-center justify-between border border-blue-500 text-black rounded-sm px-1">
                      <button
                        onClick={() => handleRemove(item.name)}
                        className="w-[50%] text-xl px-2 cursor-pointer text-blue-500"
                      >
                        -
                      </button>
