...
const CateSecB = () => {
  ...
  return (
    <div className="px-4 pb-14 space-y-4 bg-white">
      {/* Category Buttons */}
                ...
                <div className="w-[30%]">
                  {/* {qty === 0 ? (
                    <button
                      ...
                      className="w-full bg-blue-500 text-white py-1 rounded-sm flex justify-center items-center gap-1 text-sm font-medium cursor-pointer"
                    >
                      <span className="text-lg ">+</span> Add
                    </button>
                  ) : (
                    <div className="flex items-center justify-between border border-blue-500 text-black rounded-sm px-1 py-1">
                      <button
